...
@section('contenido')
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4><i class="mdi mdi-account"></i> REPORTE DE USUARIOS</h4>
                                        ...
                                        <tbody>
                                            @foreach ($vusers as $vu)
                                                <tr class="text-dark">
                                                    ...
                                                    <td>{{ $vu->personita->generos->nombre }}</td>
                                                    <td>{{ $vu->username }}</td>
                                                    <td>{{ $vu->email }}</td>
                                                    <td>{{ $vu->created_at }}</td>
                                                </tr>
    ...
    @push('styles')
        {{-- EXPORT DATATABLE --}}
        <link rel="stylesheet"
            href="{{ asset('plantillaadmin/focus/exportdatatable/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
        <link rel="stylesheet"
            href="{{ asset('plantillaadmin/focus/exportdatatable/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
        <link rel="stylesheet"
            href="{{ asset('plantillaadmin/focus/exportdatatable/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
        {{-- EXPORT DATATABLE --}}
    @endpush
    ...
    @push('scripts')
        ...
        <script src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-bs4/js/dataTables.bootstrap4.min.js') }}">
        </script>
        <script
                src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-responsive/js/dataTables.responsive.min.js') }}">
        </script>
        <script
                src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-responsive/js/responsive.bootstrap4.min.js') }}">
        </script>
        <script src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-buttons/js/dataTables.buttons.min.js') }}">
        </script>
        <script src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-buttons/js/buttons.bootstrap4.min.js') }}">
        </script>
        ...
        <script src="{{ asset('plantillaadmin/focus/exportdatatable/datatables-buttons/js/buttons.colVis.min.js') }}">
        </script>
        <script>
            $(function() {
                $("#example1").DataTable({
