...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4>EDICION DE LA CATEGORIA PRODUCTOS</h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="basic-form">
                {!! Form::open(['route'=>['catProducto.update', $vcatproducto->id],'method'=>'PUT']) !!}
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="nombre" id="nombre" value="{{ $vcatproducto->nombre }}">
