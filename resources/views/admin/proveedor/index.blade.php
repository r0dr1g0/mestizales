...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4><i class="mdi mdi-menu"></i> PROVEEDORES </h4>
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Proveedor/Empresa</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-title">
                        <button type="submit" class="form-control btn btn-success"><a href="{{ route('proveedor.create') }}">CREA UNO</a> </button>
                            ...
                            {{--  <table id="row-select" class="display table table-borderd table-hover">  --}}
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-dark">
                                        ...
                                        <td>{{$p->created_at  }}</td>
                                        <td>
                                            <a href="{{ route('proveedor.show', $p->id) }}"
                                            ...
                                            <a href="{{ route('proveedor.destroy', $p->id) }}"
